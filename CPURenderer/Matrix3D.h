...
public:
     ...
     *  @return
     */
    void decompose(Vector3D *out) const;
    /**
     ...
     *  @param dst     目标矩阵
     */
    static void getAxisRotation(float x, float y, float z, float a, float b, float c, float degress, Matrix3D &dst);
    /**
     *  预乘旋转
     *  @param degrees 角度值
     *  @param axis    轴
     *  @param pivot   锚点
     */
    void prependRotation(float degrees, const Vector3D &axis, Vector3D *pivot = nullptr);
    /**
     *  预乘缩放
     *  @param x
     *  @param y
     ...
     *  @param pivot   锚点
     */
    void appendRotation(float degrees, const Vector3D &axis, Vector3D *pivot = nullptr);
    /**
     *  追加位移
     *  @param x
     *  @param y
     ...
     *  @param vout
     */
    void transformVectors(float *vin, float *vout);
    /**
     *  倒置矩阵
     */
    void transpose();
